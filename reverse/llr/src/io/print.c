...
/**
 * Specify the static variable to hold
 * default text color
 */
static text_color_t text_color = DEFAULT_TEXT_COLOR;

/**
 * API to change the text color
 */
...
/**
 * Use this function to print a single character
 *
 * It uses a module visible variable text_color
 * to specify the hardware the color of byte to
 * ne printed
 */
...
/**
* Print the asciiz string on the display into the
* current cursor position with additional video
* buffer shifts if necessary
*
* message - asciiz string to be printed out
*/
 ...
 * uses red color as an error string color
 */
